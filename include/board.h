...
ImVec4* colors = style.Colors;
    ...
    colors[ImGuiCol_FrameBgHovered]         = IMWHITE;
    ...
    colors[ImGuiCol_ScrollbarGrabHovered]   = IMWHITE;
    ...
    colors[ImGuiCol_ButtonHovered]          = IMWHITE;
    ...
    colors[ImGuiCol_SeparatorHovered]       = IMWHITE;
    ...
    colors[ImGuiCol_TabHovered]             = IMWHITE;
